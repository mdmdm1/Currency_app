...
Revision ID: 77649878c6f3
Revises: 29947c48b15b
Create Date: 2025-01-01 12:36:01.906901
...
revision: str = "77649878c6f3"
down_revision: Union[str, None] = "29947c48b15b"
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_EMPLOYEE_employee_id"), "EMPLOYEE", ["employee_id"], unique=False
    )
    op.create_table(
        "TREASURY_OPERATIONS",
        sa.Column(
    ...
    op.create_index(
        op.f("ix_TREASURY_OPERATIONS_treasury_operations_id"),
        "TREASURY_OPERATIONS",
        ["treasury_operations_id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_TREASURY_OPERATIONS_treasury_operations_id"),
        table_name="TREASURY_OPERATIONS",
    )
    op.drop_table("TREASURY_OPERATIONS")
